...
def verify_password(plain: str, stored_hash: str) -> bool:
    ...
    try:
        ...
        # Malformed hash or non-ascii stored value — treat as a non-match
        # rather than a 500. Real bcrypt hashes always succeed or return False.
        return False
...
def _get_jwt_secret() -> str:
    ...
    log.warning(
        ...
        path=str(path),
        hint="back this file up, or set FREEAI_JWT_SECRET in production",
    )
    return secret
